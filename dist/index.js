...
const desloppify_js_1 = require("./desloppify.js");
 ...
 */
function formatReport(score, threshold, findings) {
...
exports.default = {
    ...
    hooks: {
        ...
        beforeToolCall: async (toolName, args) => {
            ...
            // Run desloppify scan
            const result = (0, desloppify_js_1.runDesloppify)();
            if (!result) {
                return {
                    proceed: true,
    ...
    tools: [
        {
            ...
            execute: async (args) => {
                ...
                const result = (0, desloppify_js_1.runDesloppify)(path);
                if (!result) {
        ...
        },
        {
            ...
            execute: async () => {
                return (0, desloppify_js_1.getNextIssue)();
            }
        },
        {
            ...
            execute: async () => {
                return (0, desloppify_js_1.getPlan)();
            }
        },
        {
            ...
            execute: async () => {
                return (0, desloppify_js_1.getDesloppifyStatus)();
            }
        },
        {
